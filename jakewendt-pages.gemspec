...
Gem::Specification.new do |s|
  ...
  s.files = [
    "app/controllers/locales_controller.rb",
     ...
     "config/routes.rb",
     "generators/pages/USAGE",
     "generators/pages/pages_generator.rb",
     "generators/pages/templates/functional/locales_controller_test.rb",
     "generators/pages/templates/functional/pages_controller_test.rb",
     "generators/pages/templates/images/drag.gif",
     "generators/pages/templates/javascripts/pages.js",
     "generators/pages/templates/migrations/create_pages.rb",
     "generators/pages/templates/stylesheets/page.css",
     "generators/pages/templates/stylesheets/pages.css",
     "generators/pages/templates/unit/page_test.rb",
     "generators/pages/templates/unit/redcloth_extension_test.rb",
     "lib/pages.rb",
     "lib/pages/factories.rb",
     "lib/pages/pending.rb",
     "lib/pages/redcloth/formatters/html.rb",
     "lib/pages/tasks.rb"
  ]
  s.homepage = %q{http://github.com/jakewendt/pages}
